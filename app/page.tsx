      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Connect with expert instructors and get your questions answered quickly and effectively.
          </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mt-20">
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
            ...
            <p className="text-white/80">
              Post your questions with detailed descriptions and get expert
              answers from experienced instructors.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
            ...
            <p className="text-white/80">
              Receive clear, detailed explanations from qualified instructors
              who care about your learning.
            </p>
          </div>
        </div>
      </div>
